...
" }")
        ...
        self.bg_color.setStyleSheet("background-color: rgb(, 215, 207);")
        self.bg_color.setText("")
        self.bg_color.setObjectName("bg_color")
        self.header_bg_color = QtWidgets.QLabel(self.centralwidget)
        self.header_bg_color.setGeometry(QtCore.QRect(0, 0, 1621, 101))
        self.header_bg_color.setStyleSheet("background-color: rgb(255, 230, 0);")
